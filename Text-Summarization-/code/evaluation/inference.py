...
#%% Main API
def batch_inference(dataset='/content/drive/MyDrive/CapstoneProject/medical_conversation_summarization-main/data',                          bin_path='/content/drive/MyDrive/CapstoneProject/medical_conversation_summarization-main/experiments/data/bin', 
                    datafolder='/content/drive/MyDrive/CapstoneProject/medical_conversation_summarization-main/experiments/data/',
                    cid='cid',
                    suffix='', 
                    refsuffix='', 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dev_suffix', type=str,  default='.source/.target',
                        help='suffix for dev set source/target files')
    parser.add_argument('--test_suffix', type=str,  default=None,
