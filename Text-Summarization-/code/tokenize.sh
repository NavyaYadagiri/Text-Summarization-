...
do
     ...
     do
         ...
         --inputs "/content/drive/MyDrive/CapstoneProject/medical_conversation_summarization-main/experiments/${EXP}/${SPLIT}${SUF}.$LANG" \
         --outputs "/content/drive/MyDrive/CapstoneProject/medical_conversation_summarization-main/experiments/${EXP}/${SPLIT}${SUF}.bpe.$LANG" \
         --workers 60 \
         #--keep-empty;
     done
 done
